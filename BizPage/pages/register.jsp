		...
		<form:form action="add" method="post" modelAttribute="customer">
			<table width="500" cell-padding=10 align="center">
				...
				<tr>
					...
					<td><form:input type="password"
							placeholder="Re-enter Password" path="confirmPassword"
							required="required" id="confirmPassword" /></td>
				</tr>

				<tr>
					<td>Mobile no</td>
					<td><form:input type="text" pattern="[1-9]{1}[0-9]{9}*"
							path="mobileNo" placeholder="your Mobile no" required="required" /></td>
				</tr>


				<%--   <tr>
            <td>Address</td>
            <td><form:input type="text" placeholder="enter your Address" path="customerFirstName"  required /></td>
          </tr> --%>
          ...
          <td>
              ...
              min="1900-12-31" max="2018-12-31">
				...
				<%-- <tr>
					...
					<td width="300"><select name="typeOfEmployment">
		...
		<%--
				<tr>
					...
					<td width="300"><form:input placeholder="Enter Retirement Age"
							type="number"
							path="customerDetails.retirementAge" name="retirementAge"
							id="retirementAge" required="required" /></td>
		...
		--%>
			...
			<%-- 
				<tr>
					...
					<td width="300"><form:input placeholder="Government / Private"
							 type="text"
							path="customerDetails.organizationType" name="organizationType"
							id="organizationType" required="required" /></td>
			...
			--%>
				...
				<tr>
					...
					<td width="300"><form:input placeholder="Organization Name"
							 type="text"
							path="customerDetails.employerName" name="employerName"
							id="employerName" required="required" /></td>
				...
				<tr>
					...
					<td width="300"><form:input placeholder="your PanNo"
			...
			<tr>
					...
					<td width="300"><form:input placeholder="Salary"
							 type="number"
							path="customerDetails.salary" name="salary"
							id="salary" required="required" /></td>
				...
				<tr>
					...
					<td width="300"><form:input type="text" id="txtAadhar"
							placeholder="your Aadhar no" onblur="AadharValidate();"
